...
public class LJParticlesLoader implements XML.ObjectLoader {
  ...
  public void saveObject(XMLControl control, Object obj) {
    ...
    control.setValue("initial_configuration", model.mdII.initialConfiguration);
    control.setValue("state", model.mdII.state);
  }
  ...
  public Object loadObject(XMLControl control, Object obj) {
    ...
    model.mdII.initialConfiguration = control.getString("initial_configuration");
    model.mdII.state = (double[]) control.getObject("state");
    int N = (model.mdII.state.length-1)/4;
    model.mdII.ax = new double[N];
    model.mdII.ay = new double[N];
    model.mdII.computeAcceleration();
    model.mdII.resetAverages();
